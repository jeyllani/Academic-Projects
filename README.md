...
> **Focus**: Dynamic Stochastic General Equilibrium (DSGE) modeling, stochastic simulation of economic crises, and analysis of agents' expectation formation. <br>
...
- **R**: Statistical analysis, econometric modeling
...
3. Review the project-specific README for dependencies
4. Run the provided code - all data is included for immediate reproduction

## Reproducibility

This repository follows best practices for reproducible research:

- All source data is preserved in original format
