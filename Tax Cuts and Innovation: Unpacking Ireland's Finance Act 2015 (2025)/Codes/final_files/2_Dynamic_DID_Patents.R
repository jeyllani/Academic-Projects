...
event_study_formula <- brevets ~ i(event_time, ref = -1) + gdp + pop + NX + public_spending  | country
...
iplot(
  ...
  ylab = "Estimated effect - log Patents",
...
output_path <- file.path("~/final_files/final_LaTeX/patents_event_study_table.tex")
